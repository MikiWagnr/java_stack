...
<form:form action="/expenses/update/${expense.id}
...
<form:input path="description" value="${expense.description}"></form:input>

<form:label path="amount">Amount: </form:label>
<from:errors path="amount"/>
<form:input path="amount" value="${expense.amount}"></form:input>
